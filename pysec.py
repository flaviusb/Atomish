#  pysec.py  - a monadic parsing library in Python 
#  Author - Peter Thatcher 
#  Website - http://www.valuedlessons.com/2008/02/pysec-monadic-combinatoric-parsing-in.html 

#  Peter has very generously allowed this code to be released as 
#  public domain.  
...
### According to the website, this is where the "meat" starts. 
######## Parser Monad ###########
